...
Claim wording: "At committed head b01b3e1, the bounded Release R6.5 experiment used a 32-frame, source-resolution 1920x1080 NV12 replay, five alternating 200-pair batches, and the same explicit .all Core ML tail. The fair direct camera-space B materialized planar Float32 RGB and ran the unchanged B2 stem in one ordered submission; direct camera-space C eliminated the resized NV12 intermediate and ran the unchanged native stem in one ordered submission. Correctness passed: accepted-path activation errors were 0, direct B/C activation max error was 8.344651e-6, top-1 agreement was 1.0, and no task disagreements were recorded. Direct B p50 post-input-to-result was 1.6923 ms and direct C p50 was 2.8522 ms; paired B-minus-C p50 was -1.5078 ms with median bootstrap 95% CI [-1.5532, -1.4729] ms. C was slower, so no camera-space fusion speedup claim is made and accepted C1 is retained for R7."
...
Accepted commit: pending final SHIP re-review; generated by b01b3e1
