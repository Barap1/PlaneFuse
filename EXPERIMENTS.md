...
## E020 - R7.5 spatial source-reuse experiment and confirmation

Date: 2026-08-11
Preregistration: `proof/R7.5-PREREGISTRATION.md`
Architecture review: `proof/reviews/R7.5-SOURCE-REUSE-ARCH-20260811.md` (`SHIP`); fixed 4x4 spatial tiles, 128 threads, cooperative Y/UV source tiles, unchanged operator/weights/tail.
Implementation commit: `c5733db8ba183c50bae7a8dbb3729d492008b10c`; quality-evidence repair/confirmation commit: `52db138feef3d6fc52bcb5839a419423fd992019`.
Protocol: Five separate Release processes, 20 warmup triples and exactly 240 measured triples per process; six B2/C1/C1-SR permutations exactly 40 times per batch; fixed 64-input corpus; explicit `.all`; persistent activation/tail boundary; raw records and deterministic 10,000-replicate block bootstrap.
Primary result: `proof/r7.5-source-reuse-final-c5733db-20260811T1550Z.json` recorded C1-SR 5.9255% below C1 and 11.5899% below B2, with positive paired median CI [0.081417, 0.094917] ms. The first artifact predates full quality-field retention and is historical.
Confirmation result: `proof/r7.5-source-reuse-final-52db138-20260811T1605Z-confirm.json` recorded B2 p50 1.737875 ms, C1 p50 1.633458 ms, and C1-SR p50 1.532583 ms. C1-SR was 6.1755% below C1 and 11.8128% below B2; C1-minus-C1-SR paired median CI [0.091125, 0.101750] ms. Activation max error was 5.960464e-6; top-1, top-5 set, and top-5 ranking agreement were all 1.0; probability max error was 0.001953125 and mean L1 was 0.001176831.
Outcome: TECHNICALLY PROMISING / PENDING FRESH HOSTILE REVIEW. The result clears the preregistered R7.5 retain gate against C1 and the >=10% comparison against fresh B2, but is not an accepted competition claim until independent review. No further performance experiment is authorized.
Lesson: In this workload, selective source-read reuse can recover useful work-sharing that direct per-channel camera-space fusion lost; this supports the measured reuse-economics framing rather than universal intermediate elimination.
