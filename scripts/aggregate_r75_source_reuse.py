...
def main() -> int:
    ...
    output = {
        ...
        "quality": {"activation_max_absolute_error": max(a["measurement"]["activation_max_absolute_error"] for a in artifacts),
                    ...
                    "c1_source_reuse_top5_set_agreement": min(a["measurement"]["c1_source_reuse_top5_set_agreement"] for a in artifacts),
                    "c1_source_reuse_top5_ranking_agreement": min(a["measurement"]["c1_source_reuse_top5_ranking_agreement"] for a in artifacts),
                    "c1_source_reuse_probability_maximum_absolute_error": max(a["measurement"]["c1_source_reuse_probability_maximum_absolute_error"] for a in artifacts),
                    "c1_source_reuse_probability_mean_l1_distance": max(a["measurement"]["c1_source_reuse_probability_mean_l1_distance"] for a in artifacts),
                    "samples": artifacts[0]["measurement"]["c1_source_reuse_quality_samples"]},
